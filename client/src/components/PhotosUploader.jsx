          ...
          addedPhotos.map((link, index) => (
            <div key={index} className="h-32 flex relative">
              ...
              <div
                ...
                className="absolute bottom-1 right-1 text-white bg-black bg-opacity-50 p-1 hover:bg-red-600 rounded-md cursor-pointer"
              >
                <svg
              ...
              <div
                ...
                className="absolute bottom-1 left-1 text-white bg-black bg-opacity-50 p-1 hover:bg-green-500 rounded-md cursor-pointer"
              >
                {link === addedPhotos[0] && (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
